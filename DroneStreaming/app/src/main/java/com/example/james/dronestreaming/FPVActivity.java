...
public class FPVActivity extends Activity implements SurfaceTextureListener,OnClickListener{
    ...
    private void initUI() {
        ...
        Button captureAction = (Button) findViewById(R.id.button1);
        Button recordAction = (Button) findViewById(R.id.button2);
        Button captureMode = (Button) findViewById(R.id.button3);
